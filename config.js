...
global.sig = 'https://instagram.com/xylocre' // ig
...
global.syt = 'https://youtube.com/channel/UC1oSMQCd3XKVxYwSh4RE2Nw' // my youtube channel "kalau ada yt ke 2 tarok link nya disini"

/*============== PAYMENT ==============*/
global.pdana = '085860179137' //dana
global.povo = '-' //ovo
global.pgopay = '-' //gopay
...
global.nomorown = '6285860179127'
global.namebot = 'XylooBotz'
global.nameown = 'LanaSukaNT'

/*============== Github Thanks To ==============*/
global.namagithub = 'Kontol' // nama github lu
global.linkgithub = 'github.com/Kontil' // tarok link github lu
...
/*============== WATERMARK ==============*/
global.wm = '                「 XylooBoTz 」' //Main Watermark
global.wm2 = '☭Xyloo-BOT☭'
global.wm3 = '⫹⫺ Xyloo-BOT '
global.botdate = `⫹⫺ TANGGAL: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `W A K T U : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By Lana`
global.packname = 'XylooBotz WhatsApp'
global.author = '                「 Lana-BOT  あ」'
...
/*============== STICKER WM ==============*/
global.stickpack = 'Lana-BOT'
global.stickauth = `By ©LanaSukaNT`
